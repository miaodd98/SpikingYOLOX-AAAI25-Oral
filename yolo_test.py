...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'model_data/x-new-b4/ep207-loss3.823-val_loss3.832.pth',      # "model_path"        : 'model_data/best_epoch_weights.pth',
    ...
    def generate(self, onnx=False):
        ...
        self.net    = YoloBody(self.num_classes, self.phi).to(device)
        # self.net = layer.StepModeContainer(True, self.net)      # 单步用这个
